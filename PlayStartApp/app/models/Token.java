...
public class Token extends Model {
    ...
    private static Model.Finder<String, Token> find = new Finder(String.class, Token.class);
     ...
     */
    private static Token getNewToken(UserApp user, TypeToken type, String email) {
     ...
     */
    public static void sendMailResetPassword(UserApp user) throws MalformedURLException {
     ...
     * @throws java.net.MalformedURLException if token is wrong.
     */
    public static void sendMailChangeMail(UserApp user, @Nullable String email) throws MalformedURLException {
     ...
     * @throws java.net.MalformedURLException if token is wrong.
     */
    private static void sendMail(UserApp user, TypeToken type, String email) throws MalformedURLException {
